...
ActiveRecord::Schema.define(version: 20140521190002) do
  ...
  add_index "tag_topics", ["tag_topic"], name: "index_tag_topics_on_tag_topic", unique: true
  ...
  add_index "taggings", ["shortened_url_id"], name: "index_taggings_on_shortened_url_id", unique: true
